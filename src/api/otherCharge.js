...
export async function createOtherCharge({ code, quantityUnit, rate, active }) {
  // eslint-disable-next-line no-console
  console.log('Calling POST /api/v1/master/billing/other-charge/create', { code, quantityUnit, rate, active });
...
export async function editOtherCharge(id, { code, quantityUnit, rate, active }) {
  // eslint-disable-next-line no-console
  console.log(`Calling PUT /api/v1/master/billing/other-charge/edit/${id}`, { code, quantityUnit, rate, active });
