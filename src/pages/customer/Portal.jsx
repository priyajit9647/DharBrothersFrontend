...
export default function CustomerPortal() {
  ...
  return (
    <Box sx={{ backgroundColor: 'grey.100', minHeight: '100vh', p: { xs: 1, sm: 1 } }}>
      <Grid container spacing={2}>
        {/* Header */}
        <Grid item xs={12}>
          <MainCard content={false} sx={{ boxShadow: 2, borderRadius: 3 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', p: { xs: 1, sm: 1.5 }, flexDirection: { xs: 'column', sm: 'row' }, gap: 1 }}>
              <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, gap: 2, alignItems: { xs: 'flex-start', sm: 'center' } }}>
                <Box>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, alignItems: { xs: 'flex-start', sm: 'center' }, mt: 0.5, flexDirection: { xs: 'column', sm: 'row' } }}>
                    <Typography variant="body2" color="text.secondary">Order Reference:</Typography>
                    <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>{orderRef}</Typography>
              ...
              <Box sx={{ display: 'flex', gap: 1, mt: { xs: 1, sm: 0 } }}>
                <Button variant="outlined" size="small">Download PDF</Button>
                <Button variant="contained" size="small">Contact Support</Button>
              </Box>
            </Box>
          </MainCard>
        </Grid>
